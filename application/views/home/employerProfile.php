...
<div class="navbar navbar-default navbar-fixed-top" data-spy="affix" data-offset-top="80" id="nav">
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav borderbot right">
                ...
                <li class="">
                    <a href="<?php echo base_url('home/employer');?>">
                        Job Posted</span>
                    </a>
                </li>

                <li class="">
                    <a href="<?php echo base_url('home/inbox');?>">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url('home/employerProfile');?>">My Profile <span class="glyphicon glyphicon-cog pull-right"></span></a></li>
                            <li class="divider"></li>
	...
	<br />
		<div class= "container">
			<div class= "col-md-12 margtopcontainer well">
				...
				<div class="col-md-8">
					<h2 style="margin: 25px">Company Description</h2>
					<p style="margin: 25px">NexusBond Asia Inc is a digital marketing company that provides a wide range of online solutions such as web development, graphic design, SEO, and more. We are currently looking for skillful applicants to become part of our CDO team. <br><br>
              ...
              Have strong user interface design skills<br><br>
				...
				<button class="btn btn-default"><span class="glyphicon glyphicon-edit"></span> &nbsp;Edit Profile</button><hr>
